...
while (!$resultat->EOF) {
	...
	$pdf->SetXY($x,$y);
	$pdf->Cell($w,$line_h,$nom_adh_ext,0,0,"C",0);
	// Print first line of adress
	$pdf->SetXY($x,$y+$line_h);
	$pdf->Cell($w,$line_h,$resultat->fields[3],0,0,"C",0);
	// Print second line of adress
	$pdf->SetXY($x,$y+$line_h*2);
	$pdf->Cell($w,$line_h,$resultat->fields[8],0,0,"C",0);
	// Print zip code and town
	$pdf->SetXY($x,$y+$line_h*3);
	$pdf->Cell($w,$line_h,$resultat->fields[5]."  -  ".$resultat->fields[6],0,0,"C",0);
	// Print country
	$pdf->SetXY($x,$y+$line_h*4);
	$pdf->Cell($w,$line_h,$resultat->fields[7],0,0,"C",0);
	$resultat->MoveNext();
	$nb_etiq++;
}
$resultat->Close();
