...
class Texts{
	...
	array('tid' => 10,'tref' => 'newadh','tsubject' => 'New registration from  {SURNAME_ADH} {NAME_ADH}', 'tbody' =>"{SURNAME_ADH} {NAME_ADH} has registred on line with login: {LOGIN}",'tlang'=> 'en_US','tcomment'=>'New registration (sent to admin)'),
	array('tid' => 11,'tref' => 'newadh','tsubject' => 'Nouvelle inscription de {SURNAME_ADH} {NAME_ADH}', 'tbody' =>"{SURNAME_ADH} {NAME_ADH} s'est inscrit via l'interface web avec le login {LOGIN}",'tlang'=>'fr_FR','tcomment'=>'Nouvelle inscription (envoyée a l\'admin)'),
	
	array('tid' => 13,'tref' => 'newcont','tsubject' => 'New contribution for  {SURNAME_ADH} {NAME_ADH}', 'tbody' =>"The contribution from {SURNAME_ADH} {NAME_ADH} has been registered (new deadline: {DEADLINE})\r\n\r\n{COMMENT}",'tlang'=> 'en_US','tcomment'=>'New contribution (sent to admin)'),
	...
	*/
	public function getTexts($ref,$lang){
		...
		if(MDB2::isError($result)){
			...
			$this->all_texts = $result->fetchRow();
		}
