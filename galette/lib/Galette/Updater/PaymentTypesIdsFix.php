...
/**
 * Free payment types ids reserved for new system types.
 *
 * User defined payment types may already use ids newly reserved for system types
 * (7 "Payment schedule" in 1.10, 8 "Stripe" and 9 "HelloAsso" in 1.21); move them
 * at the end of the list. Relations will follow, thanks to ON UPDATE CASCADE.
 *
 * @author Johan Cwiklinski <johan@x-tnd.be>
 */
trait PaymentTypesIdsFix
{
    /**
     * Move user defined payment types using ids reserved for new system types
     *
     * @param array<int,string> $types New system payment types ids and (lowercased) names
     */
    protected function freeSystemPaymentTypesIds(array $types): bool
    {
        $toupdate = [];
