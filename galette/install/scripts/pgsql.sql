...
CREATE TABLE galette_statuts (
  id_statut integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE galette_titles (
  id_title integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE galette_adherents (
    id_adh integer GENERATED BY DEFAULT AS IDENTITY,
    id_statut integer NOT NULL REFERENCES galette_statuts(id_statut) ON DELETE RESTRICT ON UPDATE CASCADE,
    ...
    tel_adh character varying(50) DEFAULT NULL,
    gsm_adh character varying(50) DEFAULT NULL,
    email_adh character varying(255) DEFAULT NULL,
    info_adh text,
    info_public_adh text,
    prof_adh character varying(150) default NULL,
...
CREATE TABLE galette_types_cotisation (
  id_type_cotis integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE galette_cotisations (
    id_cotis integer GENERATED BY DEFAULT AS IDENTITY,
    id_adh integer REFERENCES galette_adherents (id_adh) ON DELETE RESTRICT ON UPDATE CASCADE NOT NULL,
    id_type_cotis integer REFERENCES galette_types_cotisation (id_type_cotis) ON DELETE RESTRICT ON UPDATE CASCADE NOT NULL,
...
CREATE TABLE galette_preferences (
  id_pref integer GENERATED BY DEFAULT AS IDENTITY,
  nom_pref character varying(100) DEFAULT '' NOT NULL,
  val_pref text DEFAULT '' NOT NULL,
  PRIMARY KEY (id_pref)
);
...
CREATE TABLE galette_field_types (
  field_id integer GENERATED BY DEFAULT AS IDENTITY,
...
DROP TABLE IF EXISTS galette_twofactor_codes CASCADE;
DROP TABLE IF EXISTS galette_twofactor CASCADE;
...
CREATE TABLE galette_fields_categories (
  id_field_category integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE galette_fields_config (
  ...
  width_in_forms smallint DEFAULT 1 NOT NULL,
...
CREATE TABLE galette_mailing_history (
  mailing_id integer GENERATED BY DEFAULT AS IDENTITY,
...
DROP TABLE IF EXISTS galette_mailing_queue CASCADE;
...
CREATE TABLE galette_pdfmodels (
  model_id integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE galette_searches (
  search_id integer GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE galette_socials (
  id_social integer GENERATED BY DEFAULT AS IDENTITY,
  id_adh integer REFERENCES galette_adherents (id_adh) ON DELETE CASCADE ON UPDATE CASCADE,
...
DROP TABLE IF EXISTS galette_auth_attempts CASCADE;
