		<h1 id="titre">{_T string="Settings"}</h1>
...
{/if}
		...
		<div class="bigtable tabbed">
			<fieldset class="cssform" id="general">
				...
				<p>
					<label for="pref_slogan" class="bline{if $required.pref_slogan eq 1} required{/if} tooltip" title="{_T string="Enter here a short description for your association, it will be displayed on the index page and into pages' title."}">{_T string="Association's short description:"}</label>
...
{/if}
				...
				<p>
					...
					<label for="pref_adresse2" class="bline libelle{if $required.pref_adresse eq 1} required{/if}">{_T string="Address:"} {_T string=" (continuation)"}</label>
...
{/foreach}
			...
			<fieldset class="cssform" id="mail">
				...
				<p>
					<label for="pref_email_reply_to" class="bline{if $required.pref_email_reply_to eq 1} required{/if} tooltip" title="{_T string="Leave empty to use Sender Email as reply address"}">{_T string="Reply-To Email:"}</label>
				...
				<p>
					<label for="pref_email_newadh" class="bline{if $required.pref_email_newadh eq 1} required{/if} tooltip" title="{_T string="Recipient of new online registation emails"}">{_T string="Members administrator's Email:"}</label>
				...
				<p>
					<label for="pref_bool_mailadh" class="bline{if $required.pref_bool_mailadh eq 1} required{/if} tooltip" title="{_T string="Sends an email each time a new member registers online"}">{_T string="Send email to administrators ?"}</label>
				...
				<p>
					<label for="pref_editor_enabled" class="bline{if $required.pref_editor_enabled eq 1} required{/if} tooltip" title="{_T string="Should HTML editor be activated on page load ?"}">{_T string="Activate HTML editor ?"}</label>
...
{/if}
				...
				<p>
					<label for="pref_card_address" class="bline{if $required.pref_card_address eq 1} required{/if}">{_T string="Address type:"}</label>
