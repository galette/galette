...
{/if}
				...
				<tr> 
					<th {if $required.titre_adh eq 1}style="color: #FF0000;"{/if}>{_T("Title:")}</th> 
					<td>
						{html_radios name="titre_adh" options=$radio_titres checked=$data.titre_adh separator="&nbsp;&nbsp;" disabled=$disabled.titre_adh}
					</td> 
				</tr> 
				<tr> 
					<th {if $required.nom_adh eq 1}style="color: #FF0000;"{/if}>{_T("Name:")}</th> 
					<td>
				...
				<tr>
					<th {if $required.prenom_adh eq 1}style="color: #FF0000;"{/if}>{_T("First name:")}</th>
					<td><input type="text" name="prenom_adh" value="{$data.prenom_adh}" maxlength="20" {$disabled.prenom_adh}/></td>
				</tr>
				<tr>
					<th {if $required.pseudo_adh eq 1}style="color: #FF0000;"{/if}>{_T("Nickname:")}</th>
					<td><input type="text" name="pseudo_adh" value="{$data.pseudo_adh}" maxlength="20" {$disabled.pseudo_adh}/></td>
				</tr>
				<tr>
					<th {if $required.ddn_adh eq 1}style="color: #FF0000;"{/if}>{_T("birth date:")}<br/>&nbsp;</th>
					<td>
				...
				<tr>
					<th {if $required.prof_adh eq 1}style="color: #FF0000;"{/if}>{_T("Profession:")}</th>
					<td><input type="text" name="prof_adh" value="{$data.prof_adh}" maxlength="150" {$disabled.prof_adh}/></td>
				</tr>
				<tr>
					<th {if $required.pref_lang eq 1}style="color: #FF0000;"{/if}>{_T("Language:")}</th>
					<td>
				...
				<tr> 
					<th colspan="2" class="separator">{_T("Galette-related data:")}</th> 
				</tr>
				<tr>
					<th {if $required.bool_display_info eq 1}style="color: #FF0000;"{/if}>{_T("Be visible in the<br /> members list :")}</th>
...
{if $smarty.session.admin_status eq 1}
				<tr>
					<th {if $required.activite_adh eq 1}style="color: #FF0000;"{/if}>{_T("Account:")}</th> 
					<td>
				...
				<tr> 
					<th {if $required.id_statut eq 1}style="color: #FF0000;"{/if}>{_T("Status:")}</th> 
					<td>
				...
				<tr>
					<th {if $required.bool_admin_adh eq 1}style="color: #FF0000;"{/if}>{_T("Galette Admin:")}</th> 
				...
				<tr> 
					<th {if $required.bool_exempt_adh eq 1}style="color: #FF0000;"{/if}>{_T("Freed of dues:")}</th> 
...
{/if}
				<tr> 
					<th {if $required.login_adh eq 1}style="color: #FF0000;"{/if}>{_T("Username:")}<br/>&nbsp;</th> 
					<td>
				...
				<tr>
					<th {if $required.mdp_adh eq 1}style="color: #FF0000;"{/if}>{_T("Password:")}<br/>&nbsp;</th> 
					<td>
...
{if $smarty.session.admin_status eq 1}
				...
				<tr> 
					<th {if $required.date_crea_adh eq 1}style="color: #FF0000;"{/if}>{_T("Creation date:")}<br/>&nbsp;</th> 
					<td>
				...
				<tr> 
					<th {if $required.info_adh eq 1}style="color: #FF0000;"{/if}>{_T("Other informations (admin):")}</th> 
					<td>
...
{/if}
				<tr> 
					<th {if $required.info_public_adh eq 1}style="color: #FF0000;"{/if}>{_T("Other informations:")}</th> 
					<td>
...
{/if}
				...
				<tr> 
					<th colspan="2" class="separator">{_T("Contact information:")}</th> 
				</tr>
				<tr> 
					<th {if $required.adresse_adh eq 1}style="color: #FF0000;"{/if}>{_T("Address:")}</th> 
					<td>
