...
{block name="element"}
    <select name="activite_adh" id="activite_adh"{if isset($disabled) and $disabled == true} disabled="disabled"{/if}{if isset($required.activite_adh) and $required.activite_adh eq 1} required="required"{/if}>
