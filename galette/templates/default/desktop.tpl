...
{if $login->isAdmin() or $login->isStaff()}
                <a id="contribs" href="{path_for name="contributions" data=["type" => {_T string="contributions" catalog="routes"}]}" title="{_T string="View and filter contributions"}">{_T string="Contributions"}</a><br/>
                <a id="transactions" href="{path_for name="contributions" data=["type" => {_T string="transactions" catalog="routes"}]}" title="{_T string="View and filter transactions"}">{_T string="Transactions"}</a>
