{* Galette lists template *}
{extends file="page.tpl"}

{function name=draw_actions}
{*
    {foreach from=$list_actions item=list_action}
...
{block name="content"}
    {if $list->hasSearch()}
        <form action="{path_for name="{$list->getFilterPath()"}" method="post" id="filtre">
        <div id="listfilter">
{*
...
{if $list->hasMassiveActions()}
        <form action="{path_for name=$list->getBatchPath()"}" method="post" id="listform">
{/if}
