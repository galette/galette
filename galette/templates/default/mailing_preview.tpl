...
{block name="content"}
    ...
    {foreach from=$attachments item=attachment}
                    <span class="attached"><a target="_blank" href="{path_for name="previewAttachment" data=["id" => $mailing_id, "pos" => $attachment@index]}"><i class="ui link icon"></i>{$attachment->getFileName()}</a></span>
    {foreachelse}
                    -
    {/foreach}
                </dd>
