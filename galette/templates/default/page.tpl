...
{if $login->isAdmin()}
        ...
        <ul>
            ...
            <li{if $cur_route eq "configureDynamicFields"} class="selected"{/if}><a href="{path_for name="configureDynamicFields"}" title="{_T string="Manage additional fields for various forms"}">{_T string="Configure dynamic fields"}</a></li>
