...
{if $login->isAdmin()}
        ...
        <ul>
            ...
            <li{if $cur_route eq "configureCoreFields"} class="selected"{/if}><a href="{path_for name="configureCoreFields"}" title="{_T string="Customize fields order, set which are required, and for who they're visibles"}">{_T string="Configure core fields"}</a></li>
            <li{if $cur_route eq "configureDynamicFields" or $cur_route eq 'editDynamicField'} class="selected"{/if}><a href="{path_for name="configureDynamicFields"}" title="{_T string="Manage additional fields for various forms"}">{_T string="Configure dynamic fields"}</a></li>
            ...
            <li{if $cur_route eq "entitleds" and $cur_subroute eq "status"} class="selected"{/if}><a href="{path_for name="entitleds" data=["class" => {_T string="status" domain="routes"}]}" title="{_T string="Manage statuses"}">{_T string="Manage statuses"}</a></li>
            <li{if $cur_route eq "entitleds" and $cur_subroute eq "contributions-types"} class="selected"{/if}><a href="{path_for name="entitleds" data=["class" => {_T string="contributions-types" domain="routes"}]}" title="{_T string="Manage contributions types"}">{_T string="Manage contributions types"}</a></li>
