 ...
 */
define ('GALETTE_K_PATH_MAIN', $galette_k_path_main);
 ...
 * By default it is automatically calculated but you can also set it as a fixed string to improve performances..
 */
define ('GALETTE_K_PATH_URL', $galette_k_path_url);
 ...
 */
define ('K_PATH_CACHE', GALETTE_K_PATH_MAIN.'cache/');

/**
 * cache directory for temporary files (url path)
 */
define ('K_PATH_URL_CACHE', GALETTE_K_PATH_URL.'cache/');
