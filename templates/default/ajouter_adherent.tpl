...
{/if}
				...
				<TR>
					...
					<TD><input type="checkbox" name="bool_display_info" value="1" {if $data.bool_display_info eq 1}checked{/if} {$disabled.bool_display_info}></TD>
...
{if $smarty.session.admin_status eq 1}
				...
				<TR>
					...
					<TD><input type="checkbox" name="bool_admin_adh" value="1" {if $data.bool_admin_adh eq 1}checked{/if} {$disabled.bool_admin_adh}></TD> 
					<TH id="header" colspan="2">&nbsp;</TH>
				</TR> 
				<TR> 
					<TH {if $required.bool_exempt_adh eq 1}style="color: #FF0000;"{/if} id="libelle">{_T("Freed of dues:")}</TH> 
					<TD><INPUT type="checkbox" name="bool_exempt_adh" value="1" {if $data.bool_exempt_adh eq 1}checked{/if} {$disabled.bool_exempt_adh}></TD> 
					<TH id="header" colspan="2">&nbsp;</TH>
				</TR>
{/if}
				<TR> 
